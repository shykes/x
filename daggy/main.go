...
func (m Daggy) withReply(message openai.ChatCompletionMessage) Daggy {
	hist := m.loadHistory()
...
func (m Daggy) WithToolOutput(callId, content string) Daggy {
	hist := m.loadHistory()
...
func (m Daggy) WithPrompt(prompt string) Daggy {
