...
func LoadStdioFromID(id dagger.StdioID) *dagger.Stdio {
	client := initClient()
	return client.LoadStdioFromID(id)
}
...
func Stdio(opts ...dagger.StdioOpts) *dagger.Stdio {
	client := initClient()
	return client.Stdio(opts...)
}
