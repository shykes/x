...
func (r *Client) Stdio(opts ...StdioOpts) *Stdio {
...
func (r *Stdio) Proxy(ctr *Container) *Service {
...
func serveModuleDepencencies(ctx context.Context, client *Client) error {
	if err := client.ModuleSource(
		"github.com/shykes/x/stdio",
		ModuleSourceOpts{RefPin: "66f7a37dfe073eadbd5fbb55e1f26f4deebb8a42"},
	).
		WithName("stdio").
		AsModule().
		Serve(ctx); err != nil {
